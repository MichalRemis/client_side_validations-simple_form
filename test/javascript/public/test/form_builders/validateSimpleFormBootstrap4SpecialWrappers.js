QUnit.module('Validate SimpleForm Bootstrap 4 Special Fields/Wrappers', {
  before: function () {
    ...
    $('#qunit-fixture')
      .append(
        $('<form>', {
          ...
          .append($(`<div class="form-group time required user_time_of_birth form-group-invalid">
            <label class="form-control-label time required" for="user_time_of_birth_4i">
              Time of birth <abbr title="required">*</abbr>
            </label>
            <div class="d-flex flex-row justify-content-between align-items-center">
              ...
              <select id="user_time_of_birth_4i" name="user[time_of_birth(4i)]" class="form-control mx-1 is-invalid time required" data-client-side-validations-wrapper="vertical_multi_select" aria-invalid="true">
                <option value=""></option>
                <option value="00">00</option>
                <option value="23">23</option>
              </select>
              :
              <select id="user_time_of_birth_5i" name="user[time_of_birth(5i)]" class="form-control mx-1 is-invalid time required" data-client-side-validations-wrapper="vertical_multi_select" aria-invalid="true">
                <option value=""></option>
                <option value="00">00</option>
